...
namespace PetFera{
     ...
     */
    Veterinario::Veterinario(int id_, string funcao_, string nome_, string cpf_, short idade_,
            string tipo_sanguineo_, char fator_rh_, string especialidade_):
            Funcionario(id_, funcao_, nome_, cpf_, idade_, tipo_sanguineo_, fator_rh_, 
            especialidade_) {}
