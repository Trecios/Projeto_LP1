...
namespace PetFera{
     ...
     */
    Veterinario::Veterinario(int id_, string nome_, string cpf_, short idade_, short tipo_sanguineo_,
                            char fator_rh_, string especialidade_): Funcionario(id_, nome_, cpf_, idade_,
