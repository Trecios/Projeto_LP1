...
namespace PetFera{
     ...
     */
    Veterinario::Veterinario(int id_, string funcao, string nome_, string cpf_, short idade_, string tipo_sanguineo_,
                            char fator_rh_, string especialidade_): Funcionario(id_, funcao, nome_, cpf_, idade_,
